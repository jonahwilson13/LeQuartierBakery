...
function ForecastingView({ location, derived, forecastCategory, setForecastCategory, forecastItem, setForecastItem }) {
  ...
  return React.createElement(React.Fragment, null,
    React.createElement("div", {
      style: { background: "#F9F0F0", border: "1px solid #E8B9BC", borderRadius: 10, padding: "14px 18px", marginBottom: 18, maxWidth: 680 }
    },
      React.createElement("div", { style: { display: "flex", gap: 10, marginBottom: 8 } },
        React.createElement("span", { style: { fontSize: 12.5, fontWeight: 700, color: "#1A1A1A", minWidth: 92 } }, "What feeds it:"),
        React.createElement("span", { style: { fontSize: 12.5, color: "#333333" } }, "just this item's own last 8 weeks of sales at this location \u2014 nothing else.")
      ),
      React.createElement("div", { style: { display: "flex", gap: 10, marginBottom: 8 } },
        React.createElement("span", { style: { fontSize: 12.5, fontWeight: 700, color: "#1A1A1A", minWidth: 92 } }, "Week 1 vs Week 4:"),
        React.createElement("span", { style: { fontSize: 12.5, color: "#333333" } }, "one straight trend line is drawn through those 8 weeks and extended forward \u2014 Week 4 is just further along that same line. If sales are climbing or dropping, Week 4 shows more of that change than Week 1. If sales have been flat, all 4 weeks look similar \u2014 that's the model correctly saying \"no change expected,\" not a repeated number.")
      ),
      React.createElement("div", { style: { display: "flex", gap: 10 } },
        React.createElement("span", { style: { fontSize: 12.5, fontWeight: 700, color: "#1A1A1A", minWidth: 92 } }, "Low / High:"),
        React.createElement("span", { style: { fontSize: 12.5, color: "#333333" } }, "a realistic range around Medium, based on how much this item's sales have actually bounced around historically. Medium is the planning number; the range is the cushion.")
      )
    ),
