...
function WeekForecastPanel({ weekLabel, weekIdx, entry, days, isOpen, onToggle, isDessert, isLast }) {
    ...
    !entry
      ...
      : React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #E8B9BC", borderRadius: 14, padding: "18px 20px 8px", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" } },
          ...
          derived.forecastLabels.map((label, idx) => React.createElement(WeekForecastPanel, {
            ...
            isDessert: forecastCategory === "Desserts",
  ...
  return React.createElement("div", null,
    ...
    !summaries
      ...
      : React.createElement(React.Fragment, null,
          React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16, marginBottom: 30 } },
          ...
          React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 } },
            LOCATION_NAMES.map((loc) => {
              ...
              return React.createElement("div", {
                key: loc,
                style: { background: "#FFFFFF", border: "1px solid #E8B9BC", borderRadius: 12, padding: "14px 16px" }
              },
