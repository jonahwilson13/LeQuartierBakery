    ...
    React.createElement("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 12.5 } },
      React.createElement("thead", null,
        React.createElement("tr", null,
          React.createElement("th", { style: { textAlign: "left", padding: "6px 10px", color: "#8A7A63", fontWeight: 600, borderBottom: "1.5px solid #DCCDA8" } }, "Day"),
          weekLabels.map((label, i) => React.createElement("th", { key: i, style: { textAlign: "right", padding: "6px 10px", color: "#8A7A63", fontWeight: 600, borderBottom: "1.5px solid #DCCDA8" } }, `Week of ${label}`))
        )
      ),
      React.createElement("tbody", null,
        days.map((day) => React.createElement("tr", { key: day },
          React.createElement("td", { style: { padding: "6px 10px", color: "#5C4033", fontWeight: 500 } }, day),
          weekLabels.map((_, i) => React.createElement("td", { key: i, style: { padding: "6px 10px", textAlign: "right", color: "#2E2015", fontWeight: 600 } }, entry.day_forecast[day].med[i].toFixed(1)))
        )),
        React.createElement("tr", null,
          React.createElement("td", { style: { padding: "7px 10px", color: "#2E2015", fontWeight: 700, borderTop: "1.5px solid #DCCDA8" } }, "Total"),
          weekLabels.map((_, i) => React.createElement("td", { key: i, style: { padding: "7px 10px", textAlign: "right", color: "#2E2015", fontWeight: 700, borderTop: "1.5px solid #DCCDA8" } }, entry.forecast_med[i].toFixed(1)))
        )
      )
    )
  );
...
// breakdown.
const SIMPLE_COLORS = { "Breakfast & Lunch": "#9C5A22", "After 2PM": "#5B7C99" };
...
function ItemDetailCard({ name, entry, color, labels, forecastLabels }) {
  ...
  return React.createElement("div", {
    ...
    React.createElement("div", { style: { fontSize: 11.5, fontWeight: 700, color: "#8A7A63", marginTop: 14, textTransform: "uppercase", letterSpacing: "0.05em" } }, "Production Estimate — Next 2 Weeks, by Day"),
          ...
          isSimpleCategory
            ? simpleData.total.length === 0
              ? React.createElement("div", {
                  ...
                  React.createElement("div", { style: { fontFamily: "'Fraunces', serif", fontWeight: 600, fontSize: 17, color: "#2E2015", marginBottom: 8 } }, `No ${category} data for ${location}`),
              ...
              : React.createElement(React.Fragment, null,
                  React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 7, marginBottom: 16 } },
                    React.createElement("div", {
                      ...
                      style: {
                        ...
                        border: `1.5px solid ${simpleWeek === "total" ? SIMPLE_COLORS[category] : "#DCCDA8"}`,
                        background: simpleWeek === "total" ? `${SIMPLE_COLORS[category]}1A` : "transparent",
                        color: simpleWeek === "total" ? "#2E2015" : "#A8977E",
                      }
                    }, "All Weeks (Total)"),
                    simpleData.byWeek.map((w) => React.createElement("div", {
                      ...
                      style: {
                        ...
                        border: `1.5px solid ${simpleWeek === w.date ? SIMPLE_COLORS[category] : "#DCCDA8"}`,
                        background: simpleWeek === w.date ? `${SIMPLE_COLORS[category]}1A` : "transparent",
                        color: simpleWeek === w.date ? "#2E2015" : "#A8977E",
                      }
                    }, `Week of ${w.label}`))
                  ),
                  React.createElement("div", { style: { background: "#FBF6EC", border: "1px solid #DCCDA8", borderRadius: 14, padding: "20px 20px 8px", boxShadow: "0 1px 3px rgba(58,42,30,0.06)" } },
                    React.createElement("div", { style: { fontFamily: "'Fraunces', serif", fontWeight: 600, fontSize: 15, color: "#2E2015", marginBottom: 2 } }, category === "After 2PM" ? "Most Popular After 2PM" : "Most Popular Items"),
